...
- `Домашнее задание <https://forms.gle/rUYG9YscB4uup3589>`_:
    - Проделать то, что было на семинаре для выборки FashionMnist: подбор гиперпараметров модели (выполнить более подробно чем на лекции), также провести анализ полученных результатов.
    - Указать какие минусы вы увидели в подборе гиперпараметров на лекции (их как минимум 3).
...
- `Домашнее задание <https://forms.gle/nBoER9oeeFzsNpP76>`_:
    - Выбрать один из метрических классификаторов (классификации или регрессии) и выполнить поиск оптимальных параметра при помощи кросс энтропии.
