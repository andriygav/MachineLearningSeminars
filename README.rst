...
Информация
==========
- Оценка за семестр: ДЗ1 (макс 5 баллов) + ДЗ2 (макс 5 баллов). Если оценка за семестр хор(6) и выше, то автомат, а иначе зачет.
- Таблица с результатами появится утром 18.12.2023 (также будет продублирована всем на почту, кто сдавал хоть какое-то задание). Прошу проверить у всех в личном кабинете названия курса, чтобы соответсвовал названию курсу официальному. Для получения автомата требуется прийти во время семинара в 18:30 и согласиться с оценкой (по уважительной причине есь возможность согласиться с автоматом через почту в ответном письме к рассылке оценок). В случае, если оценка ниже хор(6) требуется явится для сдачи зачета/экзамена в дни согласно расписания МФТИ.
