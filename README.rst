...
Первое задание:
************************************************
- Начало: 20:00 28.09.2025.
- Сдавать лично в течении семестра, в конце семинара. Первая задача без штрафа до 12.10.2026, до 19.10.2026 сдача за половину баллов.

Третья задание:
************************************************
- Начало: 20:00 03.11.2025.
- Сдавать лично в течении семестра, в конце семинара. Задача без штрафа до 24.11.2025, далее за половину баллов.
...
Пятое задание:
************************************************
- Начало: 20:00 24.11.2025.
- Сдавать лично в течении семестра, в конце семинара. Задача без штрафа до 15.12.2025, далее за половину баллов.
- `Генератор задания <https://github.com/andriygav/MachineLearningSeminars/blob/master/hometask/task1-5/generator.ipynb>`_:
    - В качестве почты нужно ввести почту в домене @phystech.edu.
    - После ввода почты, вам будет предложена выборка с ссылкой для скачивания, а также методы, которые нужно проанализировать для данной выборки.
- Требуется:
    - Провести анализ выборки:
