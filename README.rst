...
Предварительные оценки за курс на `странице <https://docs.google.com/spreadsheets/d/12_HyzEgygfmjsY835FLugNN5CjUD6746Vi3_zAZPhLk/edit?usp=sharing>`_, если я что-от не учел не нашел или Вас нету в ведомости или Вы есть в ведомости, но не должны, то сообщите мне пожалуйста.

В субботу (19.12.2020) в 12:20 можно прийти, чтобы обудить оценки, неявка означает согласие с оценкой (20.12.2020 все что в таблице будет внесено в ведомость).
...
- `Домашнее задание <https://forms.gle/i2ErjGdx8BEHF9xK8>`_:
...
- `Домашнее задание <https://forms.gle/5qFmJxpbBjBmwvDY8>`_:
